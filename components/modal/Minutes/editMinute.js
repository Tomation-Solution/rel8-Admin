...
export default function EditMinute(props) {
  ...
  return (
    <View style={tw`m-auto bg-white rounded-xl w-10/12`}>
        <View style={tw`border-b border-purple-300 my-3 mx-5`}>
            <Text style={tw`font-bold text-lg text-center text-purple-500`}>Edit Minute</Text>
        </View>

        <InputField label='Title' setText={setName} />
        
        <InputField label='Date' setText={setPhone} />
        <InputField label='Cateegory' setText={setEmail} />
        <InputField label='File ' setText={setName} />
